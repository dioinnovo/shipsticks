...
Coverage A - Building Protection
We cover the commercial building on the business premises shown in the Declarations, including structures attached to the building, and materials and supplies located on or adjacent to the business premises for use in the construction, alteration or repair of the building.

Coverage B - Other Structures Protection
We cover other structures on the business premises, separated from the main building by clear space. Structures connected to the building by only a fence, utility line, or similar connection are considered other structures.
...
1. The National Weather Service issues a hurricane watch or warning for any part of the state where the business premises is located
...
**Hurricane Coverage:**
- Your commercial building (Coverage A) is protected against windstorm damage during hurricanes
- Other structures on your property (Coverage B) are also covered at 10% of your building limit
