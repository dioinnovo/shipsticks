        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <Link 
                href="/demo"
                className="text-gray-600 dark:text-gray-400 hover:text-scc-red transition"
              >
                Demo
              </Link>
              <Link 
                  ...
                  <tr>
                    <td colSpan={10} className="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                      <div className="flex justify-center items-center gap-2">
                        <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-scc-red" />
                        Loading claims...
                      </div>
                    </td>
                  </tr>
                    ...
                    <tr key={claim.id} className="hover:bg-gray-50 dark:bg-gray-900">
                      ...
                      <td className="px-6 py-4">
                        <Link
                          ...
                          className="text-scc-red hover:text-red-600 transition"
                        >
                          <Eye size={18} />
                        </Link>
                      </td>
