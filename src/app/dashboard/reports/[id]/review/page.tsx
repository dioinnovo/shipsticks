  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center min-h-96">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-scc-red"></div>
      </div>
    )
  }
      ...
      >
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            className="w-full h-24 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-scc-red/20 focus:border-scc-red resize-none"
          />
        </div>
