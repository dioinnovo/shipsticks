...
• Policy type (HO3, HO5, DP3, Commercial Property, BOP, CPP, etc.)
...
COVERAGE LIMITS:
• Coverage A (Dwelling/Building) limit
...
• Hurricane/Windstorm deductible (amount or percentage)
...
• Hurricane/Named storm coverage specifics
...
• ALE/Loss of Use limits (residential)
• Business Income limits (commercial)
• Time limitations and coverage periods
• Coverage triggers and prohibited use
...
• Coverage A (Dwelling/Building): $[amount]
...
• Hurricane/Windstorm: $[amount] or [%] of Coverage A
...
• Hurricane/Windstorm deductible application
...
• Required notices present (Yes/No for each):
  - Hurricane/Windstorm deductible notice
