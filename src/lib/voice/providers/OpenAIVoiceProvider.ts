...
export class OpenAIVoiceProvider extends IVoiceProvider {
  ...
  private getFreshInstructions(): string {
    return `You are Scotty, an AI assistant helping with insurance claim settlements.
         ...
         0. GREETING - "Hi there! I'm Scotty, your AI assistant. I'm here to help you find the right solutions for your insurance claim needs. May I know who I'm speaking with?"
