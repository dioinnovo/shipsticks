...
export default function ROICalculator() {
  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
      {/* Header */}
      <div className="bg-scc-red text-white p-6">
        <div className="flex items-center gap-3 mb-2">
          <Calculator className="w-8 h-8" />
          <h2 className="text-2xl font-bold">ROI Calculator</h2>
        </div>
        <p className="text-red-100">See your potential return with SCC Intelligence Platform</p>
      </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
            <Target className="w-5 h-5 text-scc-red" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-scc-red focus:border-scc-red"
              />
            </div>
        ...
        <div className="space-y-4 pt-6 border-t border-gray-200 dark:border-gray-700">
          ...
          {/* ROI Summary */}
          <div className="bg-gradient-to-r from-scc-red to-red-600 rounded-xl p-6 text-white">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                <p className="text-red-100 text-sm">Annual ROI</p>
                <p className="text-3xl font-bold mt-1">{formatCurrency(results.totalROI)}</p>
              </div>
              <div>
                <p className="text-red-100 text-sm">ROI Multiple</p>
                <p className="text-3xl font-bold mt-1">{results.roiMultiple.toFixed(1)}x</p>
              </div>
              <div>
                <p className="text-red-100 text-sm">Break-Even</p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <button className="flex-1 bg-scc-red text-white px-6 py-3 rounded-full font-semibold hover:bg-scc-red-dark transition-colors flex items-center justify-center gap-2">
              Start Your Pilot Program
              <ChevronRight className="w-5 h-5" />
            </button>
            <button className="flex-1 bg-white dark:bg-gray-900 border-2 border-scc-red text-scc-red px-6 py-3 rounded-full font-semibold hover:bg-red-50 transition-colors">
              Download ROI Report
            </button>
          </div>
        </div>
