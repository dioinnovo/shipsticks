      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <label
              htmlFor="file-upload"
              className="inline-flex items-center px-4 py-2 bg-scc-red text-white rounded-lg hover:bg-red-600 cursor-pointer transition"
            >
              Select Files
            </label>
          </div>
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    {file.uploadStatus === 'uploading' && (
                      <Loader2 className="w-5 h-5 text-scc-red animate-spin" />
                    )}
          ...
          <div className="flex justify-end space-x-3">
            ...
            <Button
              ...
              className="bg-scc-red hover:bg-red-600"
            >
              {isUploading ? (
                <>
