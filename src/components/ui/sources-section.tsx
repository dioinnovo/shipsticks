    ...
    <div className="mt-3">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="text-xs px-3 py-1.5 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-scc-red hover:text-scc-red transition flex items-center gap-1"
        >
              ...
              {sources.map((source, index) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-gradient-to-r from-gray-50 to-gray-50/50 dark:from-gray-900 dark:to-gray-900/50 rounded-xl p-4 cursor-pointer border border-gray-200 dark:border-gray-700 hover:border-scc-red/50 transition-all"
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex items-start gap-3 flex-1">
                        {/* Document Icon */}
                        <div className="p-2 bg-scc-red/10 rounded-lg">
                          <DocumentIcon className="w-5 h-5 text-scc-red" />
                        </div>
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-700">
                          ...
                          {sourceText.length > 200 && (
                            <div className="absolute bottom-0 left-0 right-0 h-8 bg-gradient-to-t from-white dark:from-gray-800 to-transparent rounded-b-lg flex items-end justify-center pb-1">
                              <span className="text-xs text-scc-red font-medium">Click to view full text</span>
                            </div>
                          )}
                        </div>
                      </div>
